...
- **ID tình huống**: T-02
- **Mô tả ngắn**: Khi người dùng upload chứng từ mờ, AI có xu hướng trích xuất sai số liệu (vd: 8 thành 0), gây tính sai số thuế phải nộp cho người dùng.
- **Mức độ**: Nặng
- **Điểm rủi ro**: 25
- **Vì sao chọn tình huống này**: Đây là lỗi phổ biến nhất của công nghệ OCR và gây thiệt hại tài chính trực tiếp, khiến người dùng mất niềm tin vào sản phẩm ngay lập tức.
...
**Nguyên nhân gốc**: AI Vision/OCR có độ tin cậy không ổn định với ảnh chất lượng thấp và hệ thống thiếu cơ chế xác thực dữ liệu quan trọng.

**Tầng chính cần sửa**: Kiến trúc lai (Architecture) + Giao diện cảnh báo (UI/UX).

**Vì sao cần 3 lớp giải pháp**:

- Lớp giao diện: Giúp người dùng trực giác thấy điểm AI nghi ngờ để kiểm tra lại.
- Lớp chỉ dẫn AI: Ngăn AI "đoán mò" và buộc AI phải check logic trước khi xuất kết quả.
- Lớp kiến trúc dữ liệu: Dùng nhiều phương pháp OCR khác nhau để đảm bảo tính khách quan và chính xác của số liệu.
