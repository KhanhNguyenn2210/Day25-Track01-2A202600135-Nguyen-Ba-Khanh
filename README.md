...
Day 25 là bài tập cá nhân. Sinh viên bắt đầu từ các rủi ro đã xác định, kết thúc bằng **bộ kiểm thử cuối** (10-15 tình huống) + **3 lớp giải pháp** cho rủi ro quan trọng nhất.
...
Cú pháp: **`Day25-MãSốSinhViên`**

Ví dụ: `Day25-2A202600135`.

### Cần nộp những file gì?

Sinh viên tạo **1 kho GitHub công khai**, đưa toàn bộ thư mục `worksheet/` lên GitHub theo đúng cấu trúc dưới, rồi nộp link qua LMS.

```text
Day25-MSSV/                                         ← kho GitHub công khai
│
├── README.md                                       ← Thông tin cá nhân (xem mẫu dưới)
│
└── worksheet/
...
🎯 = file người chấm xem trước. Các file còn lại là **trung gian** — phải nộp kèm để người chấm thấy sinh viên đã đi qua đủ quá trình.
...
```markdown
# Day 25 — Chủ đề 01: Trợ lý AI Quyết toán thuế TNCN

## Thông tin cá nhân

| # | Mã học viên | Họ tên đầy đủ |
|---|-------------|---------------|
| 1 | 2A202600135 | Nguyễn Bá Khánh |
...
AI chỉ hỗ trợ dựng bản nháp. Sinh viên vẫn chịu trách nhiệm kiểm tra nguồn, sửa nội dung, và chốt quyết định cuối.
...
| AI viết xong là nộp | Sinh viên phải đọc, sửa, kiểm chứng |
